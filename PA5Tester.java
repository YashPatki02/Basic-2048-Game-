...
//
// To improve my PA5 code, I added a try and catch block around the canMove() 
// method to fix and error I got from the autograder. I also modified the 
// move() method to make the logic simpler. Previously it could enter two 
// if-statements when it was supposed to enter just one, so I added an if 
// and else block to ensure it enters only one and returns the correct boolean. 
//
// Additionally, I tried to implement a switch block with the cases being 
// each of the directions to reduce repetition with the if, else-if, and 
// else statements, however, my compiler DrJava did not let me compile with -
//    
//  Error: Cannot switch on a value of type java.lang.String. 
//           Only convertible int values or enum constants are permitted
// 
// I commented the code that I would have implemented if I could, which would
// greatly improved the readability and simplicity of the code.   
//
//////////////////////////// 80 columns wide //////////////////////////////////
...
public class PA5Tester {
    ...
    */
    ...
    private int testCanMove()
    {
        ...
        if (board3.canMove(board3.UP) && board3.canMove(board3.RIGHT) &&
                !board3.canMove(board3.DOWN)) {
            //Passed, do nothing.
        }
        else {
            System.out.println("FAILED!");
            if (!board3.canMove(board3.UP)) {
                System.out.println("Board should be able to move UP:");
            }
